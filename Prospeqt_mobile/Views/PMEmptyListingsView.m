//
//  PMEmptyListingsView.m
//  Prospeqt_mobile
//
//  Created by Ryan Leung on 11/9/13.
//  Copyright (c) 2013 Prospeqt. All rights reserved.
//

#import "PMEmptyListingsView.h"

@interface PMEmptyListingsView()
@property (nonatomic, strong) UILabel *placeholderLabel;
@end

@implementation PMEmptyListingsView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        placeholderLabel.text = NSLocalizedString(@"listings.empty.text", @"empty text");
